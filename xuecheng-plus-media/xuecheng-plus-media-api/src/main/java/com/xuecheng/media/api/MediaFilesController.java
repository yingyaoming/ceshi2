...
public class MediaFilesController {
    ...
    @RequestMapping("/upload/coursefileNew")
    public MediaFiles PictureUpload(@RequestPart("fileData") MultipartFile fileData) {
        if (fileData == null){
            new XueChengPlusException("文件是空");
        }


        MediaFiles uploadFileResultDto = mediaFileService.uploadFileNew(fileData);
